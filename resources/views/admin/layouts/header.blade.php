<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="{{ route('admin.home') }}">Pet Sitting</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li><a class="dropdown-item" href="{{ route('admin.profileDetails') }}"><i class="fa fa-user fa-lg"></i> Profile</a></li>
